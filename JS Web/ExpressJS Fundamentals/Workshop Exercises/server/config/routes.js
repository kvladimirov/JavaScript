...
module.exports = (app) => {
  ...
  app.post('/cars/add', auth.isInRole('Admin'), upload.single('image'), controllers.cars.addPost)
  ...
  app.post('/cars/edit/:id', auth.isInRole('Admin'), upload.single('image'), controllers.cars.editPost)
